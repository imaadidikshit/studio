...
const signupBackground = PlaceHolderImages.find(img => img.id === 'signup-background');
  ...
  return (
    <div className="min-h-screen w-full lg:grid lg:grid-cols-2 bg-background">
      ...
      >
        <Link
          href="/"
          className="flex items-center space-x-2 text-foreground z-10"
        >
        ...
        <div className="absolute inset-0 z-0">
          {signupBackground && (
            <Image
              src={signupBackground.imageUrl}
              alt={signupBackground.description}
              fill
              objectFit="cover"
              className="opacity-20"
              data-ai-hint={signupBackground.imageHint}
            />
          )}
      ...
      <div className="flex items-center justify-center p-6 sm:p-12 relative overflow-hidden">
        <Link
          href="/"
          className="absolute top-6 left-6 flex items-center space-x-2 text-foreground z-10 lg:hidden"
        >
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="grid gap-4">
            ...
            <Button
              type="submit"
              className="w-full mt-2 rounded-full font-bold text-lg py-6"
            >
              Create an account
            </Button>
          </form>
